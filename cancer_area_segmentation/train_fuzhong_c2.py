...
from cancer_area_segmentation.data.image_producer import ImageDataset
torch.manual_seed(0)
...
parser.add_argument('--save_path', default='ckpt/tumor_level1_linchuang', type=str,
                    help='Path to the saved models')
#parser.add_argument('--ckpt_path',default='ckpt/ckpt_resnet18_2_m_w_0412/best.ckpt', type=str,help='Path to the trained saved models')
